...
contract MuContinent is Context, IERC20, Ownable {
    ...
    string private _name = "Mu continent";
    ...
    uint256 public fomoInterval = 7200;	//2h
    uint256 public _minFoMoBalance = 100000 * 10**9; 
    uint256 public numTokensSellToFoMo = 10500000 * 10**9;		//0.01%
    ...
    uint256 public numTokensSellToAddToLiquidity = 1050 * 10**6 * 10**9;		//0.5%
	...
	function _updateTopPlayers(address sender, address recipient, uint256 rAmountOut, uint256 rAmountIn) private{
        ...
        uint256 amountOut = rAmountOut.div(currentRate);
        uint256 amountIn = rAmountIn.div(currentRate);
